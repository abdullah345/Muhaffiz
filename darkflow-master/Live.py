...
nf=150
f=77
capture = cv2.VideoCapture(r"Dataset/USB Drive\Videos\NegShrt/vid ("+str(f)+").mp4")
#capture = cv2.VideoCapture("Dataset/fg.mp4")
...
#        M = cv2.getRotationMatrix2D((cols/2,rows/2),-90,1)#IDher yawai
...
cv2.imwrite(os.path.join(path , "v"+str(f)+'.png'),hog_img_uint8 )                
capture.release()
